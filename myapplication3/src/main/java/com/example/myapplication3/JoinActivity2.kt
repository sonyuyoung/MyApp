...
import com.example.myapplication3.databinding.ActivityJoin2Binding
import java.io.File
...
class JoinActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.radio1.setOnCheckedChangeListener { buttonView, isChecked ->
            Toast.makeText(this@JoinActivity2, "남자 클릭됨", Toast.LENGTH_SHORT).show()
        }
        binding.radio2.setOnCheckedChangeListener { buttonView, isChecked ->
            Toast.makeText(this@JoinActivity2, "여자 클릭됨", Toast.LENGTH_SHORT).show()
        }
    ...
    fun UpdateData() {
        buttonUpdate!!.setOnClickListener {
            ...
            if (isUpdated)
                Toast.makeText(this@JoinActivity2, "데이터 수정 성공", Toast.LENGTH_LONG).show()
            else Toast.makeText(this@JoinActivity2, "데이터 수정 실패", Toast.LENGTH_LONG).show()
        }
    }
    ...
    fun DeleteData() {
        buttonDelete!!.setOnClickListener {
            ...
            if (deleteRows > 0)
                Toast.makeText(this@JoinActivity2, "데이터 삭제 성공", Toast.LENGTH_LONG)
                    .show()
            else Toast.makeText(this@JoinActivity2, "데이터 삭제 실패", Toast.LENGTH_LONG)
                .show()
        }
    }
