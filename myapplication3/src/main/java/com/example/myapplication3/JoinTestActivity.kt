...
import com.example.myapplication3.databinding.ActivityJoinTestBinding
import java.io.File
import java.text.SimpleDateFormat
import java.util.Date

class JoinTestActivity : AppCompatActivity() {
     lateinit var binding: ActivityJoinTestBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityJoinTestBinding.inflate(layoutInflater)
        ...
        binding.radio1.setOnCheckedChangeListener { buttonView, isChecked ->
            Toast.makeText(this@JoinTestActivity, "남자 클릭됨", Toast.LENGTH_SHORT).show()
        }
        binding.radio2.setOnCheckedChangeListener { buttonView, isChecked ->
            Toast.makeText(this@JoinTestActivity, "여자 클릭됨", Toast.LENGTH_SHORT).show()
        }
    ...
    fun AddData() {
        joinInBtn!!.setOnClickListener {
            ...
            if (isInserted == true)
                Toast.makeText(this@JoinTestActivity, "데이터추가 성공", Toast.LENGTH_LONG)
                    .show()
            else Toast.makeText(this@JoinTestActivity, "데이터추가 실패", Toast.LENGTH_LONG).show()
        }
    }
    ...
    fun UpdateData() {
        buttonUpdate!!.setOnClickListener {
            ...
            if (isUpdated)
                Toast.makeText(this@JoinTestActivity, "데이터 수정 성공", Toast.LENGTH_LONG).show()
            else Toast.makeText(this@JoinTestActivity, "데이터 수정 실패", Toast.LENGTH_LONG).show()
        }
    }
    ...
    fun DeleteData() {
        buttonDelete!!.setOnClickListener {
            ...
            if (deleteRows > 0)
                Toast.makeText(this@JoinTestActivity, "데이터 삭제 성공", Toast.LENGTH_LONG)
                    .show()
            else Toast.makeText(this@JoinTestActivity, "데이터 삭제 실패", Toast.LENGTH_LONG)
                .show()
        }
    }
